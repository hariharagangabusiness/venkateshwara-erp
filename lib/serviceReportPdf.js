...
async function generateServiceReportPdf(report, sr, company, spares) {
  ...
  if (!browserPath) {
    throw new Error(
      'No Chrome/Edge/Chromium browser found on this machine. Service Report PDFs are generated using your installed ' +
      'browser. Install Google Chrome or Microsoft Edge, or set PDF_CHROME_PATH, then try again.'
    );
  }
