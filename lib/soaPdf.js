...
function soaHtml(client, ledger, period, company) {
  ...
  return `<!doctype html><html><head><meta charset="utf-8"><style>
    ...
    table{width:100%;border-collapse:separate;border-spacing:0;margin-top:10px;} thead{display:table-header-group;} tr{page-break-inside:avoid;} th,td{box-shadow:inset 0 0 0 1px #999;padding:5px 7px;font-size:11px;text-align:left;}
