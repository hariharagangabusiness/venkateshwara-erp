...
function bodyHtml(offer, client, items, techSpecs, boughtOut, terms, company) {
...
async function generateOfferPdf(offer, client, items, techSpecs, boughtOut, terms) {
  ...
  try {
    ...
    await page.setContent(bodyHtml(offer, client, items, techSpecs, boughtOut, terms, getCompanySettings()), { waitUntil: 'load' });
    await page.pdf({
      path: outPath,
      format: 'A4',
...
module.exports = { generateOfferPdf, bodyHtml };
