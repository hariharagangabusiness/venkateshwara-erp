...
function foreignPaymentHtml(fp, company) {
  return `<!doctype html><html><head><meta charset="utf-8"><style>
    ...
    table{width:100%;border-collapse:collapse;margin-top:8px;} th,td{border:1px solid #999;padding:5px 6px;font-size:11px;text-align:left;}
  ...
  ${documentStampHtml({
    docType: 'Foreign Payment Request',
    reference: fp.request_no,
    partyLabel: 'Beneficiary',
    partyName: fp.beneficiary_name,
    date: new Date(fp.created_at).toLocaleDateString(),
